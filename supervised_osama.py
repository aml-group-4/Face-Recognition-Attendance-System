...
model_path = 'supervised_embedding_osama.pth'
model_cnn = torch.load(model_path, map_location=torch.device('cpu'))
...
def generate_embedding(image):
    ...
    with torch.no_grad():  # No need to track gradients
        embedding = model_cnn(preprocessed_image)
...
################### APP IMPLEMENTATION ###################
app = ctk.CTk()
app.title("Face Recognition Attendance System | Supervised Model by Osama")
